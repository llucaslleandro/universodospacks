...
function iniciarPopupsSociais() {
  setTimeout(() => {
    mostrarPopupSocial();
    setInterval(mostrarPopupSocial, 60000);
  }, 5000);
}
    ...
    const tourDriver = driverInstance({
      ...
      steps: [
        ...
        },
        {
          ...
          popover: {
            title: '📊 Ordenação',
            description: 'Ordene os produtos por <strong>menor preço</strong>, <strong>maior preço</strong> ou <strong>mais populares</strong>.',
            side: 'bottom',
            align: 'end'
          }
        },
        ...
        },
        {
          ...
          popover: {
            ...
            description: 'Clique em <strong>"Comparar"</strong> para adicionar produtos à comparação. Compare até 3 celulares lado a lado!',
            side: 'top',
            align: 'center'
          }
        },
        {
          ...
          onDeselected: () => {
            const btn = document.getElementById('btn-compare');
            if (comparacao.length === 0 && btn.getAttribute('data-tour-shown')) {
